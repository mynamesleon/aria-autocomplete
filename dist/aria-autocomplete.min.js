...
"use strict";function e(e){return null==e?"":(e+"").trim()}function t(t,r){var n=t,a=e(n.getAttribute&&n.getAttribute("class"));return" ".concat(a," ").indexOf(" ".concat(r," "))>-1}function r(t,r){for(var n=e(t.getAttribute&&t.getAttribute("class")),a=" "+n+" ",o="",i=0,l=r.split(" "),s=l.length;i<s;i+=1)""!==l[i]&&-1===a.indexOf(" "+l[i]+" ")&&(o+=" "+l[i]);n!==(o=e(n+o))&&t.setAttribute("class",o)}function n(t,r){for(var n=e(t.getAttribute&&t.getAttribute("class")),a=" "+n+" ",o=0,i=r.split(" "),l=i.length;o<l;o+=1)a=a.replace(" "+i[o]+" "," ");n!==(a=e(a))&&t.setAttribute("class",a)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.trimString=e,exports.hasClass=t,exports.addClass=r,exports.removeClass=n,exports.cleanString=s,exports.isPrintableKey=c,exports.mergeObjects=u,exports.dispatchEvent=f,exports.setElementState=v,exports.processSourceArray=p,exports.htmlToElement=h,exports.setCss=d,exports.transferStyles=m,exports.searchVarPropsFor=x,exports.removeDuplicatesAndLabel=y;var a=/&/g,o=/\s\s+/g,i=/[\u2018\u2019',:\u2013-]/g,l=/[\-\[\]{}()*+?.,\\\^$|#\s]/g;function s(t){var r=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return t=(t=(t=(t=e(t).toLowerCase()).replace(i,"")).replace(a,"and")).replace(o," "),r&&(t=t.replace(l,"\\$&")),t}function c(e){return e>=48&&e<=57||e>=65&&e<=90||e>=96&&e<=111||e>=186&&e<=222||32===e||8===e||46===e}function u(){for(var e={},t=0,r=arguments.length;t<r;t+=1){var n=t<0||arguments.length<=t?void 0:arguments[t];for(var a in n)n.hasOwnProperty(a)&&void 0!==n[a]&&(e[a]=n[a])}return e}function f(e,t){if("createEvent"in document){var r=document.createEvent("HTMLEvents");r.initEvent(t,!0,!0),e.dispatchEvent(r)}else e.fireEvent("on"+t)}function v(e,t,r){t=!!t,e&&("INPUT"===e.nodeName&&"boolean"==typeof e.checked&&e.checked!==t&&(e.checked=t,f(e,"change")),"OPTION"===e.nodeName&&e.selected!==t&&(e.selected=t,r.elementChangeEventTimer&&clearTimeout(r.elementChangeEventTimer),r.elementChangeEventTimer=setTimeout(function(){f(e.closest("select"),"change")},1)))}function p(e){for(var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=arguments.length>2?arguments[2]:void 0,n=[],a=t.value,o=t.label,i=0,l=e.length;i<l;i+=1){var c={},f=e[i];if("string"==typeof f)c.value=c.label=f;else{var v=(c=u(f))[a]||c.value||c.label,p=c[o]||c.label||c.value;c.value=(v||"").toString(),c.label=(p||"").toString()}!1!==r&&(c.ariaAutocompleteCleanedLabel=s(c.label)),n.push(c)}return n}var g=document.createElement("div");function h(t){return g.innerHTML=e(t),g.firstChild}function d(e,t){if(e)for(var r in t){var n="number"==typeof t[r]?t[r]+"px":t[r];e.style[r]=n+""}}function m(e,t,r){if(e&&t){var n=getComputedStyle(e),a={};if(r&&r.length)for(var o=0,i=r.length;o<i;o+=1)a[r[o]]=n[r[o]];else a=n;d(t,a)}}var b=function e(t,r,n){if("string"==typeof t)return"ariaAutocompleteCleanedLabel"!==n&&(t=s(t,!1)),-1!==t.search(r);if(Array.isArray(t))for(var a=0,o=t.length;a<o;a+=1)if(e(t[a],r))return!0;return!1};function x(e,t,r){var n=arguments.length>3&&void 0!==arguments[3]&&arguments[3];for(var a in n&&(r=s(r,!0)),e)if(e.hasOwnProperty(a)){var o=!1;if("string"==typeof e[a]){for(var i=t.length;i--;)if(t[i]===a){o=!0;break}}else o=Array.isArray(e[a]);if(o&&b(e[a],r,a))return!0}return!1}function y(t){for(var r=[],n=0,a=t.length;n<a;n+=1)if("string"==typeof t[n]){for(var o=e(t[n]),i="label"!==o,l=r.length;i&&l--;)r[l]===o&&(i=!1);i&&r.push(o)}return r}
